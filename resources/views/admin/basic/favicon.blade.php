        ...
        <div class="card-body pt-5 pb-4">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form class="mb-3 dm-uploader drag-and-drop-zone" enctype="multipart/form-data" action="{{route('admin.favicon.update')}}" method="POST">
                <div class="form-row">
                  <div class="col-md-12 d-md-block d-sm-none mb-3">
                    @if (file_exists('assets/front/img/favicon.jpg'))
                      <img src="{{asset('assets/front/img/favicon.jpg?'.time())}}" alt="..." class="img-thumbnail">
                    @else
